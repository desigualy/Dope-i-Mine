...
class PronunciationSetupScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PronunciationSetupScreen> createState() =>
      _PronunciationSetupScreenState();
}

class _PronunciationSetupScreenState
    extends ConsumerState<PronunciationSetupScreen> {
  ...
  void initState() {
    ...
    final detected =
        ref.read(brandingRepositoryProvider).detectRegionalDefault(locale);
