...
class _YGLayout extends Struct {
  @Float()
...
class LayoutStyleFFI extends LayoutStyle implements Finalizable {
  ...
  set flex(double? value) =>
      _yogaStyleSetFlex(_nativePtr, value == null ? double.nan : value);
  ...
  set flexGrow(double? value) =>
      _yogaStyleSetFlexGrow(_nativePtr, value == null ? double.nan : value);
  ...
  set flexShrink(double? value) =>
      _yogaStyleSetFlexShrink(_nativePtr, value == null ? double.nan : value);
