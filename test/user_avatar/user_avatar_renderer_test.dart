...
void main() {
  testWidgets('user avatar renderer delegates to Avatar V3 renderer', (tester) async {
  ...
  testWidgets('privacy-first avatar still uses Avatar V3 renderer', (tester) async {
    const profile = UserAvatarProfile(
